...
//    }
    ...
    public String updateSubmit (
            @RequestParam(value = "npm", required = false) int npm, StudentModel student)
    {
        StudentModel student1 = new StudentModel (student.getNpm(), student.getName(), student.getGpa());
